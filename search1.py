...
effnet = timm.create_model(model_name, pretrained=True, num_classes=0, global_pool='avg')  # Use 'avg' for global average pooling
effnet.eval()
...
START_ID = ''  # Specify the ID from where you want to start

if __name__ == "__main__":
    input_csv = "photo_metadata.csv"
    output_csv = "extracted_feature_1.csv"
